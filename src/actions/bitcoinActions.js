...
export const getData = ({ time, number }) => async (dispatch) => {
  try {
    ...
    const response = await axios.get(
      `https://financialmodelingprep.com/api/v3/historical-chart/${time}/BTCUSD?apikey=2ee67c377ee95397ef85b696787de66b`
    );
    ...
    // console.log(data);
    // console.log(labels);
    dispatch({ type: "SUCCESS_BITCOIN", payload: { data, labels } });
  } catch (error) {
